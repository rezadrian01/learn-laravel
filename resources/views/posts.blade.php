    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <form class="max-w-md mx-auto mb-8">
            ...
            <div class="relative">
                ...
                <input autofocus autocomplete="off" name="search" type="search" id="default-search"
        ...
        <div class="mt-4 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($posts as $post)
                <article
                    ...
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <a class="text-gray-800 {{$post->category->color}} hover:underline"
                    ...
                    <div class="text-sm flex justify-between items-center">
                        ...
                        <a href="/posts/{{$post->slug}}"
                           class="inline-flex text-blue-500 items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                            Read more
            ...
            @empty
                <div>
                    <h2 class="font-bold text-xl">Post not found</h2>
